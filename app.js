...
// Your code here:
const numsTimeTwo = nums.map(el => el * 2);
...
console.log('firstIngredient:', firstIngredient, 'secondIngredient:', secondIngredient);
...
const userProfile = {};
userProfile[propertyName] = 'MyFirstUsername';
console.log('userProfile:', userProfile);

// Exercise 7: other files
